...
const FilterPokemonModal = ({ isVisible, onClose, onApplyFilter, onClearFilter, initialFilter }) => {
  ...
  return (
    <View className="p-4">
      <View className="mb-2">
        <Text className="text-[12px] text-slate-800 mb-1">Nome:</Text>
        <TextInput
      ...
      <View className="mb-4">
        <Text className="text-[12px] text-slate-800 mb-1">Tipo:</Text>
        <TextInput
          className="border border-slate-300 p-1 rounded-md"
          value={filterType}
      ...
      <View className="flex-row justify-around">
        <TouchableOpacity onPress={handleClearFilter} className="p-2 px-4 rounded-md bg-red-600">
          <Text className="text-slate-50 font-extrabold text-[16px]">Limpar</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={handleApplyFilter} className="p-2  px-4 rounded-md bg-green-600">
          <Text className="text-slate-50 font-extrabold text-[16px]">Aplicar</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
